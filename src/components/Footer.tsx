        ...
        <SimpleGrid columns={{ base: 1, md: 2, lg: 4 }} gap={10}>
          <VStack align="flex-start" gap={4}>
            ...
            <Text color="fg.muted" fontSize="sm" lineHeight="1.7">
              Técnico certificado UTN con 16 años de experiencia en aires acondicionados, lavarropas, microondas y hornos eléctricos. CABA y GBA, atención rápida y trabajos garantizados.
            </Text>
            <HStack gap={2}>
              <IconButton
                as="a"
