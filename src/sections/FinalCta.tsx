    ...
    <Box as="section" py={{ base: 16, md: 20 }}>
      <Container>
        <MotionBox
          ...
          overflow="hidden"
          p={{ base: 8, md: 14 }}
          bgGradient="linear-gradient(135deg, #002E75 0%, #0D1117 100%)"
          borderWidth="1px"
        ...
        >
          <Box
            position="absolute"
            inset={0}
            bg="radial-gradient(circle at 70% 30%, rgba(0,139,244,0.20) 0%, transparent 60%)"
            pointerEvents="none"
          />
          <Box
            position="absolute"
          ...
          <Stack position="relative" zIndex={1} align="center" gap={5} textAlign="center" maxW="3xl" mx="auto">
            ...
            >
              ...
              <Box as="span" bgGradient="linear-gradient(135deg, #008BF4 0%, #5FB4FB 100%)" bgClip="text">
                {' '}profesionales
              </Box>
            </Heading>
            ...
            <HStack gap={3} flexWrap="wrap" justify="center" mt={2}>
              <Button
                ...
                fontWeight="700"
                borderRadius="full"
                boxShadow="0 16px 36px -10px rgba(34,197,94,0.25)"
              ...
              <Button
                ...
                _hover={{ bg: 'rgba(0,139,244,0.10)', borderColor: 'border.accent' }}
                transition="all 0.25s"
              >
